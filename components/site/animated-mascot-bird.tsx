...
export function AnimatedMascotBird({
  ...
  return (
    <div
      ref={rootRef}
      className={`ic-animated-bird ic-animated-bird--fly-${direction} ${isFlying ? "is-flying" : ""} ${className}`}
      aria-hidden={alt === ""}
    >
      <div className="ic-animated-bird__turn">
        <svg
        ...
        >
          ...
          <path
            ...
            fill="black"
          />
          <g className="ic-animated-bird__wing-rig">
            <path
          ...
          <g className="ic-animated-bird__tail-rig">
            <path
